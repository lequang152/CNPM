...
public class nhanvienform extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldNGAYSINH = new com.toedter.calendar.JDateChooser();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CNPM/Form/hinh/nhanvien.png"))); // NOI18N
        ...
        them.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CNPM/Form/hinh/THEM.png"))); // NOI18N
        ...
        sua.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CNPM/Form/hinh/SUA.png"))); // NOI18N
        ...
        xoa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CNPM/Form/hinh/delete.png"))); // NOI18N
        ...
        thoat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CNPM/Form/hinh/THOAT.png"))); // NOI18N
        ...
        jButtonclear.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CNPM/Form/hinh/CLEAR.png"))); // NOI18N
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jTextFieldNGAYSINH, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(jTextFieldTENNV, javax.swing.GroupLayout.DEFAULT_SIZE, 181, Short.MAX_VALUE)
        ...
        jPanel9Layout.setVerticalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel5)
                    .addComponent(jTextFieldLUONG, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel9Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(sua, javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(xoa, javax.swing.GroupLayout.Alignment.TRAILING))
                .addContainerGap(80, Short.MAX_VALUE))
        );

        jTextFieldNGAYSINH.setDateFormatString("dd/MM/yyyy");
    ...
    private void jTableNhanvienMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableNhanvienMouseClicked
        ...
        jTextFieldNGAYSINH.setDate(Date.valueOf(model.getValueAt(i, 4).toString()));
        ...
        jTextFieldMANV.setBackground(new Color(240, 240, 240));
    ...
    private void jButtonclearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonclearActionPerformed
        ...
        jTextFieldNGAYSINH.setCalendar(null);
        jTextFieldGIOITINH.setText("");
        jTextFieldCHUTHICH.setText("");
        jTextFieldMANV.requestFocus();
        jTextFieldMANV.setEditable(true);
        jTextFieldMANV.setBackground(new Color(255,255,255));
    ...
    private void suaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_suaActionPerformed
        ...
        if (jTableNhanvien.getSelectedRow()==-1) {
            ...
            if(jTextFieldMANV.getText().equals("") || jTextFieldTENNV.getText().equals("") || jTextFieldCHUCVU.getText().equals("") || jTextFieldNGAYSINH.toString().equals("") || jTextFieldLUONG.getText().equals("") ||jTextFieldGIOITINH.getText().equals("") ||jTextFieldCHUTHICH.getText().equals("")) {
                showMessageDialog(this, "Không có đủ thông tin");
                return;
            }
            DefaultTableModel model = (DefaultTableModel) jTableNhanvien.getModel();
            String old = model.getValueAt(jTableNhanvien.getSelectedRow(), 0).toString();
            System.out.print(old);
            Connection con = getConnection();
            try {
            // Tạo một đối tượng để thực hiện công việc
            st = (Statement) con.createStatement();
            String query = "UPDATE nhanvien set MANV = "+ "'" +jTextFieldMANV.getText()+ "'" +
                    ", TENNV =" + "'" +jTextFieldTENNV.getText()+ "'" + 
                    ", CHUCVU =" + "'" +jTextFieldCHUCVU.getText()+  "'" +
                    ", LUONGNV =" + "'" +jTextFieldLUONG.getText()+  "'" +
                    ", NGAYSINH = " + "'" + new java.sql.Date(jTextFieldNGAYSINH.getDate().getTime()) + "'" + 
                    ", GIOITINH =" + "'" +jTextFieldGIOITINH.getText()+  "'" + 
                    ", CHUTHICH =" + "'" +jTextFieldCHUTHICH.getText()+  "'" + 
                    " where MANV = " + "'" + old + "'" ;
    ...
    private void themActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_themActionPerformed
        ...
        try {
            ...
            + "'" + jTextFieldTENNV.getText() + "','" + jTextFieldCHUCVU.getText() + "','" + jTextFieldLUONG.getText() + "','" + new java.sql.Date(jTextFieldNGAYSINH.getDate().getTime()) + "','" + jTextFieldGIOITINH.getText() + "','" + jTextFieldCHUTHICH.getText() + "')";
    ...
    private com.toedter.calendar.JDateChooser jTextFieldNGAYSINH;
